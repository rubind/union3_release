...
* simple_Gaussian_check.py python script that reads all_samples_union3_cosmo=2.npz and shows some summary statistics on the spline nodes (all_samples_union3_cosmo=2.npz is the (n_samples x n_nodes) spline-node MCMC samples).
